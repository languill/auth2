                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    ...
                                    <?php else: ?>
                                        <span class="rounded-circle profile-image d-block " style="background-image:url('images/avatar.png'); background-size: cover;"></span>
                                    <?php endif; ?>    
                                </span>

                                        
                                <div class="info-card-text flex-1">  
                                    <a href="page_profile.php?id=<?php echo $user['id']; ?>" class="fs-xl text-truncate text-truncate-lg text-info"><?php echo $user['username'];?></a>
                                    <?php if (($admin) || ($currentUser == $user['id'])): ?>
                                    ...
                                    <div class="dropdown-menu"> <!-- редакт. начало -->
                                        ...
                                        <a href="delete/<?php echo $user['id']?>" class="dropdown-item" onclick="return confirm('вы уверены?');">
