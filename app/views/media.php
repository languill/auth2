...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="/mediaForm" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xl-6">
                    <?= $flash ?>
                    <div id="panel-1" class="panel">
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
								...
								<?php if($user['avatar']) : ?>
                                    <img src="/images/<?php echo $user['avatar']?>" class="img-responsive" width="200">
								<?php else: ?>
									<img src="/images/avatar.png" class="img-responsive" width="200">
								<?php endif; ?> 
                                </div>
