...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="addUserForm" method="POST" enctype="multipart/form-data">
            <?= $flash ?>
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    <label class="form-label text-success" for="simpleinput">Имя</label>
                    ...
                    <div id="panel-1" class="panel">
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                <!-- email -->
                                <div class="form-group">
                                    <label class="form-label text-success" for="simpleinput">Email</label>
                                    <input type="text" name="email" id="simpleinput" class="form-control">
                                </div>

                                <!-- password -->
                                <div class="form-group">
                                    <label class="form-label text-success" for="simpleinput">Пароль</label>
